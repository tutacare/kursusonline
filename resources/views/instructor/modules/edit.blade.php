        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('instructor.courses.modules.update', [$course->id, $module->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="order" class="block mt-1 w-full" type="number" name="order" :value="old('order', $module->order)" required />
